...
public class RemoteViewActionTest {
  ...
  @Before public void setUp() {
    AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(Robolectric.application);
    appWidgetIds =
        shadowOf(appWidgetManager).createWidgets(AppWidgetProvider.class, R.layout.list_content, 3);
    picasso =
  ...
  @Test public void completeSetsBitmapOnRemoteViews() throws Exception {
    RemoteViewAction action =
        new RemoteViewAction(picasso, null, remoteViews, appWidgetIds, 1, 0, false, URI_KEY_1);
  ...
  @Test public void errorWithResourceSetsResource() throws Exception {
    RemoteViewAction action =
        new RemoteViewAction(picasso, null, remoteViews, appWidgetIds, 1, 1, false, URI_KEY_1);
    action.error();
